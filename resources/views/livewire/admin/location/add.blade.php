<div class="container mt-3">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" wire:submit.prevent="storeLocation">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="link" class="form-label">Link (jika online)</label>
                    <input type="text" class="form-control" id="link" name="link" wire:model="link"
                        placeholder="Masukkan link lokasi (jika online)">
                </div>
                <div class="mb-3">
                    <label for="detail_address" class="form-label">Alamat Lengkap</label>
