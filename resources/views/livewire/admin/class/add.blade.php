    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" wire:submit.prevent="storeClass">
                ...
                <div class="mb-3">
                    <label for="location_id" class="form-label fw-bold">Lokasi</label>
                ...
                <div class="mb-3">
                    <label for="day" class="form-label fw-bold">Hari</label>
                ...
                <div class="mb-3">
                    <label for="color" class="form-label fw-bold">Warna Kelas</label>
