        ...
        <div class="row g-4">
                ...
                <div class="card h-100 shadow-sm border-0 hover-shadow transition-all">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-calendar-week me-2"></i> Senin & Rabu</li>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 shadow-sm border-0 hover-shadow transition-all">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-calendar-week me-2"></i> Selasa & Kamis</li>
                            <li class="mb-2"><i class="bi bi-clock me-2"></i> 19.00 - 20.30 WIB</li>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card h-100 shadow-sm border-0 hover-shadow transition-all">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-calendar-week me-2"></i> Sabtu & Minggu</li>
